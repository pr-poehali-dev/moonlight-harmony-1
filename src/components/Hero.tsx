  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/812e46a0-f3fe-4b25-844a-8c8adadc8f79/files/7a8cde90-e139-4565-b9a1-f69ad261b807.jpg"
          alt="Роскошные шторы в интерьере"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Оптовые портьерные ткани — Москва"}</p>
          ...
          >
            {"Ткани оптом"}
            <br />
            <span style={{ color: "#C9A961" }}>{"для профессионалов"}</span>
          </h1>
        </div>
      </div>
